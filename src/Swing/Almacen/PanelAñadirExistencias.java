...
public class PanelAñadirExistencias extends JPanel {
	private JTextField txtNombre;
	private JTextField txtCantidad;
	/**
	 * Create the panel.
	 */
	public PanelAñadirExistencias() {
		setLayout(null);
		...
		JLabel lblAñadirCliente = new JLabel("A\u00D1ADIR EXISTENCIAS");
		...
		lblAñadirCliente.setBounds(220, 28, 412, 51);
		...
		btnAñadir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(!txtNombre.getText().isEmpty() && !txtCantidad.getText().isEmpty()) {
					Empresa.anhadirExistencias(Integer.parseInt(txtNombre.getText()),Integer.parseInt(txtCantidad.getText()));
					lblResultado.setText("CANTIDAD AÑADIDA");
				}
				else {
					lblResultado.setText("ERROR AL AÑADIR, COMPRUEBE LOS DATOS");
				}
		...
		lblNewLabel_1.setIcon(new ImageIcon(PanelAñadirExistencias.class.getResource("/imagenes/YY.png")));
